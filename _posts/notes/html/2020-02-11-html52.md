...
js代码应该放在window.onload()函数中，否则会报错：Uncaught TypeError: Cannot read property 'getContext' of null，因为在html元素加载之前就运行了JavaScript。
...
#### &emsp;&emsp;5.2fillText()

在 canvas 上绘制实心的文本

<font color="aqua">格式：</font>

`fillText(text,x,y)` text代表文本，xy代表坐标。
...
#### &emsp;&emsp;6.1createLinearGradient()
...
#### &emsp;&emsp;6.2createRadialGradient()
