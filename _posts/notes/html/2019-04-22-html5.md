...
tags: html HTML 基础 5 table border th headers scope colspan rowspan tr td caption colgroup span col thead tbody tfoot cellpadding ul ol reversed dl
excerpt: "表格与列表"
---
...
`<th colspan="规定表头单元格应该横跨的列数。">内容</th>`

<font color="orange">注意：</font>

colspan="0" 告知浏览器使单元格横跨到列组 (colgroup) 的最后一列。目前仅firefox支持
...
`<th rowspan="规定表头单元格应该横跨的行数。">`

<font color="orange">注意：</font>

rowspan="0" 告知浏览器使单元格横跨到表格组件中的最后一个行（thead、tbody 或 tfoot）。仅firefox与opera支持
