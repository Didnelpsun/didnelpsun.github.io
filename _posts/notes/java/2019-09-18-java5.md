...
tags: java 基础 5 字符串 String length indexOf lastIndexOf charAt substring trim replace startsWith endsWith equals equalsIngoreCase compareTo loLowerCase toUpperCase split String-Builder append insert delete 格式化 format SimpleDateFormat
excerpt: "字符串（String类）"
---
...
#### &emsp;&emsp;7.1 日期时间字符串格式化

导入Date包:`import java.util.Date`  

对于Date类详细请看[java基础7]({% post_url /notes/java/2019-09-25-java7 %})

然后需要创建Date对象然后对这个对象格式化然后输出。  

##### &emsp;&emsp;&emsp;7.1.1 format()函数
...
##### &emsp;&emsp;&emsp;7.1.2 SimpleDateFormat类
...
##### &emsp;&emsp;&emsp;7.1.3 printf()函数
