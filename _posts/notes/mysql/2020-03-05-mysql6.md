...
详细的[语言环境表]({% post_url notes/mysql/2020-03-11-lc_time_names %})

#### &emsp;&emsp;1.13DAYTOFWEEK()
...
#### &emsp;&emsp;2.3ADDTIME()、SUBTIME()、TIMEDIFF()
...
#### &emsp;&emsp;3.2DATE_ADD()、DATE_SUB()
...
#### &emsp;&emsp;4.3FROM_UNIXTIME()、UNIX_TIMESTAMP()
